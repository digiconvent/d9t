...
type IamUserRepositoryInterface interface {
	CreateUser(user *iam_domain.User) (*uuid.UUID, *core.Status)
	GetUserByEmailaddress(emailaddress string) (*iam_domain.User, *core.Status)
	GetUserByID(id *uuid.UUID) (*iam_domain.User, *core.Status)
